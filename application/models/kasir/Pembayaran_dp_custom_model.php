...
class Pembayaran_dp_custom_model extends CI_Model {
    ...
    public function get_all()
    {
        return $this->db
            ...
            ->where('tbl_pembayaran.jenis_pembayaran', 'uang_muka_custom')
    ...
    public function cek_pelunasan($id_pesanan)
    {
        return $this->db
            ->where('id_pesanan', $id_pesanan)
            ->where('jenis_pembayaran', 'pelunasan_custom')
            ->get('tbl_pembayaran')
            ->row();
    }
