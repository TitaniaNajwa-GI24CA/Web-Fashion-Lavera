...
$route['pesanan/nota-pakaian-jadi/(:num)'] = 'pesanan/nota_pakaian_jadi/$1';
$route['pesanan/nota-custom/(:num)'] = 'pesanan/nota_custom/$1';
$route['admin/laporan-penjualan-pakaian-jadi'] = 'admin/laporan_penjualan_pakaian_jadi';
$route['admin/laporan-penjualan-custom'] = 'admin/laporan_penjualan_custom';
$route['admin/laporan-pakaian-jadi-pdf'] = 'admin/laporan_penjualan_pakaian_jadi/download_pdf';
$route['admin/laporan-pakaian-jadi-excel'] = 'admin/laporan_penjualan_pakaian_jadi/download_excel';
$route['admin/laporan-custom-pdf'] = 'admin/laporan_penjualan_custom/download_pdf';
$route['admin/laporan-custom-excel'] = 'admin/laporan_penjualan_custom/download_excel';
$route['cart'] = 'cart/index';
$route['cart/tambah/(:num)'] = 'cart/add/$1';
$route['cart/delete/(:num)'] = 'cart/delete/$1';
$route['cart/update'] = 'cart/update';
$route['cart/clear'] = 'cart/clear';
$route['notifikasi'] = 'notifikasi';
$route['notifikasi/detail/(:num)'] = 'notifikasi/detail/$1';